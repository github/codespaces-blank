 ...
 * @remarks This happens to be the initial state of the builder API.
 */
export interface PostRecord<ADT extends StoredADT, R extends SomeStoredRecord, Vs extends StoredRecords> extends RecordRequired<ADT, [R, ...Vs]>, Done<ADT, R, Vs> {
 ...
 */
export interface PostSchema<ADT extends StoredADT, R extends SomeStoredRecord, Rs extends StoredRecords> extends RecordRequired<ADT, [R, ...Rs]>, Done<ADT, R, Rs> {
...
export declare namespace StoredADT {
    type Create<Name extends SomeName = SomeName> = StoredADT<Name>;
}
