...
export interface EnvironmentArgumentReport<Spec extends ParameterSpec.Output = ParameterSpec.Output> extends Argument {
    spec: Spec;
...
export type ParseErrorGlobal = Errors.Global.ErrorUnknownFlag | Errors.Global.ErrorUnknownParameterViaEnvironment;
export type ParseErrorBasic = Errors.ErrorMissingArgument | Errors.ErrorInvalidArgument | Errors.ErrorFailedToGetDefaultArgument | Errors.ErrorDuplicateEnvArg | Errors.ErrorDuplicateLineArg;
export type ParseErrorExclusiveGroup = Errors.ErrorArgumentsToMutuallyExclusiveParameters | Errors.ErrorMissingArgumentForMutuallyExclusiveParameters | ParseErrorBasic;
export type ParseError = ParseErrorBasic | ParseErrorExclusiveGroup | Errors.ErrorDuplicateEnvArg | LocalParseErrors;
...
export type ParseResultExclusiveGroup = ParseResultExclusiveGroupSupplied | {
    _tag: 'omitted';
    spec: ParameterSpec.Output.ExclusiveGroup;
