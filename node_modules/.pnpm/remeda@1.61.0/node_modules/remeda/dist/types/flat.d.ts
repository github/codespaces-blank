 ...
 * @category Array
 */
export declare function flat<T extends IterableContainer, Depth extends number = typeof DEFAULT_DEPTH>(data: T, depth?: IsNumericLiteral<Depth> extends true ? Depth : never): FlatArray<T, Depth>;
/**
 * Creates a new array with all sub-array elements concatenated into it
 * recursively up to the specified depth. Equivalent to the built-in
 * `Array.prototype.flat` method.
 ...
 * @category Array
 */
export declare function flat<Depth extends number = typeof DEFAULT_DEPTH>(depth?: IsNumericLiteral<Depth> extends true ? Depth : never): <T extends IterableContainer>(data: T) => FlatArray<T, Depth>;
export {};
