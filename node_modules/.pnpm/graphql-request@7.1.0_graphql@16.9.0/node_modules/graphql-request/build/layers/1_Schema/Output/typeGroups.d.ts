...
export type UnwrapToNamed<$Type extends Any> = $Type extends List<infer $Inner> ? UnwrapToNamed<$Inner> : $Type extends Nullable<infer $Inner> ? UnwrapToNamed<$Inner> : $Type;
//# sourceMappingURL=typeGroups.d.ts.map