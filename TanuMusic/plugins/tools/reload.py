...
from TanuMusic.utils.database import get_assistant, get_authuser_names, get_cmode
from TanuMusic.utils.decorators import ActualAdminCB, AdminActual, language
from TanuMusic.utils.formatters import alpha_to_int, get_readable_time
...
async def restartbot(client, message: Message, _):
    ...
    if chat_id:
        ...
        try:
            db[chat_id] = []
            await Tanu.stop_stream_force(chat_id)
        except:
            pass
